...
public enum DamageType
{
	...
	BLUNT_PROJECTILE(DamageVariant.PHYSICAL, DamageCause.PROJECTILE, 0.5, 0.75, 1.0, 1.0),

	/** Damage dealt by normal attacks, such as swords, punches, etc */
	NORMAL(DamageVariant.PHYSICAL, DamageCause.ENTITY_ATTACK, 1.0, 1.0, 1.0, 1.0),
	/** Damage dealt by normal ranged attacks, such as arrows, etc */
	NORMAL_PROJECTILE(DamageVariant.PHYSICAL, DamageCause.PROJECTILE, 1.0, 1.0, 1.0, 1.0),
	...
	PIERCING_PROJECTILE(DamageVariant.PHYSICAL, DamageCause.PROJECTILE, 0.25, 0.75, 0.5, 1.0),
